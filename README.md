...
* Sets swap automatically when using Goblin Brainwasher. Saving using the brainwasher will save a corresponding set, loading using the brainwasher will load the matching set. -Ehawne
